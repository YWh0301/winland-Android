...
object AhbPresenterBridge {
    ...
    @JvmStatic private external fun nativeCreateOuterCursor(surface: Surface, generation: Int, x: Int, y: Int): Int
    ...
    fun createOuterCursor(surface: Surface, generation: Int, x: Int, y: Int): Int =
        nativeCreateOuterCursor(surface, generation, x, y)
